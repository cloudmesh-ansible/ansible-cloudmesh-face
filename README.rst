...
* Docker: Follow .. _Docker Mac OSX Installation Guide:  https://docs.docker.com/engine/installation/mac/ to start a docker machine and connect your shell to it prior to building the container. 
